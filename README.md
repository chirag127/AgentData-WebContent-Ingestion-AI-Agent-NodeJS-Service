# AgentData Web Content Ingestion AI Agent

[![Built With](https://img.shields.io/badge/Built%20With-Vite%20%26%20TypeScript-blueviolet?style=for-the-badge&logo=typescript)](https://vitejs.dev)
[![UI Framework](https://img.shields.io/badge/UI-React%20%26%20Tailwind-blue?style=for-the-badge&logo=react)](https://react.dev)
[![Architecture](https://img.shields.io/badge/Architecture-Frontend--Only-orange?style=for-the-badge)](./AGENTS.md#2-frontend-only-architecture-critical-mandate)
[![AI Providers](https://img.shields.io/badge/AI-Multi--Provider-brightgreen?style=for-the-badge&logo=openai)](./AGENTS.md#3-ai-orchestration--multi-provider-protocol-mandatory)
[![License](https://img.shields.io/badge/License-CC%20BY--NC%204.0-lightgrey?style=for-the-badge)](./LICENSE)
[![CI/CD](https://img.shields.io/github/actions/workflow/status/chirag127/AgentData-WebContent-Ingestion-AI-Agent-NodeJS-Service/ci.yml?branch=main&style=for-the-badge&logo=githubactions)](./.github/workflows/ci.yml)

A professional, frontend-only website for interacting with multiple AI providers to fetch and process web content directly in your browser. This repository is a demonstration of a modern, serverless, and secure AI-powered web application, fully compliant with the AGENTS.md Dec 2025 standards.
...
-   🧠 **Multi-Provider AI Orchestration**: Integrates with Cerebras, Google Gemini, Groq, Mistral, NVIDIA, and Cloudflare.
